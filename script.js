...
document.addEventListener("keydown", function (e) {
  switch (e.key) {
    case "+":
      pressOperator(document.querySelector("button:nth-child(1)"));
      break;
    case "-":
      pressOperator(document.querySelector("button:nth-child(2)"));
      break;
    case "*":
    ...
    case "2":
      ...
      break;
    case "3":
      pressNum(document.querySelector("button:nth-child(8)"));
      break;
    case "4":
